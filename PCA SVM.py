...
a = ('Accuracy for SVM: %.2f' % accuracy_score(y_test, y_pred))
b = ('training accuracy for SVM: %.3f' % lr.score(X_train_pca, y_train))
c = ('Test accuracy for SVM: %.3f' % lr.score(X_test_pca, y_test))
...
with open("PCA_SVC_output.txt", "w") as text_file:
