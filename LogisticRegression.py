...
#
# Objective:
# To Classify and predict Cars dataset using Logistic Regression for high safety >= HighPrice
# #*************************************************************************************
...
classifier = LogisticRegression(random_state = 1)  #Logistic classifier
classifier.fit(X_train_norm, y_train)


y_pred = classifier.predict(X_test_norm)  #predicting test results
...
print('Test Accuracy for LogisticRegression: %.2f' % classifier.score(X_test_norm, y_test))
print('Train Accuracy for Tree: %.2f' % classifier.score(X_train_norm, y_train))
# plot data
