...
b = ('training accuracy for LR: %.3f' % lr.score(X_train_lda, y_train))
c = ('Test accuracy for LR: %.3f' % lr.score(X_test_lda, y_test))
...
with open("LDA_LR_output.txt", "w") as text_file:
