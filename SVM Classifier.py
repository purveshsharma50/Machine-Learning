...
#
# Objective:
# To Classify and predict Cars dataset using SVM model for high safety >= HighPrice
# #*************************************************************************************
...
y_pred = svclassifier.predict(X_test_norm)
...
print('training accuracy for SVM: %.2f' % svclassifier.score(X_train_norm, y_train))
print('Test accuracy for SVM: %.2f' % svclassifier.score(X_test_norm, y_test))
# plot data
