...
a=('Test Accuracy: %.3f' % pipe_lr.score(X_test, y_test))
...
#Training the model and determining optimized parameters
...
with open("LR hypertunning PCA_output.txt", "w") as text_file:
